    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(validators=[users.validators.birth_date_validator])),
                ('email', models.EmailField(max_length=254, validators=[users.validators.email_validator])),
